...
@section('title', 'My Lab Results - HMS')
...
<div class="page-header">
    <h2><i class="fas fa-flask" style="color: #0d47a1;"></i> My Lab Results</h2>
</div>

<div class="table-container">
    @if($labResults && count($labResults) > 0)
            ...
            <tbody>
                @foreach($labResults as $result)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('patient.lab-result.detail', $result->id) }}" class="action-btn">
