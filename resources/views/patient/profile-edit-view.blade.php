    ...
    <form method="POST" action="{{ route('patient.profile.update') }}">
        ...
        <div class="form-row">
            ...
            <div>
                ...
                <input type="date" class="form-control @error('date_of_birth') is-invalid @enderror" name="date_of_birth" value="{{ old('date_of_birth', $patient->date_of_birth ? $patient->date_of_birth->format('Y-m-d') : '') }}" required>
        ...
        <div style="margin-top: 30px;">
            <button type="submit" name="save_edit" value="1" class="btn-save">
