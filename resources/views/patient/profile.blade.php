...
<div class="metrics-row">
    <div class="metric-card">
        <p class="metric-number">{{ $totalAppointments ?? 12 }}</p>
        <p class="metric-text">Total Appointments</p>
    </div>
    <div class="metric-card">
        <p class="metric-number">{{ $upcomingAppointments ?? 3 }}</p>
        <p class="metric-text">Upcoming Visits</p>
    </div>
    <div class="metric-card">
        <p class="metric-number">{{ $labResults ?? 5 }}</p>
...
<div class="main-grid">
    ...
    <div class="profile-card">
        ...
        <div class="info-grid">
            ...
            <div class="info-item">
                ...
                <span class="info-value">{{ $patient->date_of_birth ?? 'N/A' }}</span>
            </div>
            <div class="info-item">
            ...
            <div class="info-item">
                ...
                <span class="info-value">{{ ucfirst($patient->gender) ?? 'N/A' }}</span>
            </div>
            <div class="info-item">
            ...
            <div class="info-item">
                ...
                <span class="info-value">{{ $patient->blood_group ?? 'N/A' }}</span>
            </div>
            <div class="info-item">
                <span class="info-label">Pincode</span>
                <span class="info-value">{{ $patient->pincode ?? 'N/A' }}</span>
            </div>
        </div>
        ...
        <a href="{{ route('patient.profile.edit') }}" class="btn-edit">
    ...
    <div class="side-card">
        ...
        <div class="side-item">
            ...
            <span class="side-value">{{ $patient->created_at->format('M d, Y') ?? 'N/A' }}</span>
        </div>

        <div class="side-item">
            <span class="side-label">Last Updated</span>
            <span class="side-value">{{ $patient->updated_at->format('M d, Y') ?? 'N/A' }}</span>
        </div>
