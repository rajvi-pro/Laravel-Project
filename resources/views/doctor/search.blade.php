                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card h-100 shadow-sm border-0">
                                <div class="card-body">
                                    ...
                                    <p class="card-text mb-0"><strong>Date of Birth:</strong> {{ $patient->date_of_birth ? $patient->date_of_birth->format('M d, Y') : 'N/A' }}</p>
                                </div>
                                <div class="card-footer bg-transparent border-0">
                                    <a href="{{ route('doctor.patient.details', $patient->id) }}" class="btn btn-primary btn-sm">View Details</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
